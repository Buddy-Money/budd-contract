...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x55Dca01ab0136Bfe74987c421C73D63Af55B114E;
...
contract BUDD is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xEcfEE2020290fa04C61a796329d86a33f5C55BE8;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Buddy Money";
    string private _symbol = "BUDD";
